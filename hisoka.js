...
return hisoka.sendMessage(m.chat, { document: await getBuffer(url), mimetype: mime, caption: caption, mentions: men ? men : []}, {quoted: m })
	  ...
	  // Anti Link
        ...
        m.reply(`「 ANTI LINK 」\n\nKamu terdeteksi mengirim link group lain, maaf kamu tidak layak berada di group jadi kamu akan di kick !`)
...
sendFileFromUrl(m.chat, `${result}`,`By *Riyo Xdz*\nJgnLupa Subs *RIYO XDZ*\nYT : https://bit.ly/3GtHDNH`)
                break
case 'sewabot':
...
*•LINK : https://telegra.ph/file/d037bef4febdc91086a08.jpg*
...
break
            case 'sc': {
                m.reply('*SCRIPT BOT MINAMI*\nEnc : https://www.mediafire.com/file/31pj0wa614d7t0e/Minami.zip/file\nNo Enc : Chat Owner')
            }
            break
            case 'chat': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://bit.ly/3GtHDNH'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+62 812 2391 8622'
                                }
                            }, {
                                quickReplyButton: {
...
case 'audioyt': case 'ytaudio': {
    ...
    m.reply(mess.wait)
          ...
          sendFileFromUrl(m.chat,`${wipi}`,`By *Riyo Xdz*\nJgnLupa Subs *RIYO XDZ*\nYT : https://bit.ly/3GtHDNH`)
break
	    case 'ppcp': {
                m.reply(mess.wait)
		...
		let { quotesAnime } = require('./lib/scraper')
            ...
            break
            case 'blackpink':
if (!q) return m.reply(`Example : ${prefix + command} Riyo`)
anu = await fetchJson (`https://app-botpri.herokuapp.com/api/textpro/black-pink?apikey=Fxc7&text=${q}`)
sendFileFromUrl(m.chat,`${anu.result}`,`By *Riyo Xdz*\nJgnLupa Subs *RIYO XDZ*\nYT : https://bit.ly/3GtHDNH`)
break
case 'wolflogo':
...
break
case 'leaves':
if (!q) return m.reply(`Example : ${prefix + command} RiyoXdz`)
...
case 'greenleaves':
case 'lolbanner':
if (!q) throw `Example : ${prefix + command} Riyo`
m.reply(mess.wait)
...
if (!q) throw `Example : ${prefix + command} Riyo`
m.reply(mess.wait)
sendFileFromUrl(m.chat, `https://x-daniapi.herokuapp.com/api/ephoto/${command}?text=${q}&apikey=DaniXFar`, `By *Riyo Xdz*\nJgnLupa Subs *RIYO XDZ*\nYT : https://bit.ly/3GtHDNH`)
break
	    case 'nomerhoki': case 'nomorhoki': {
                if (!Number(text)) throw `Example : ${prefix + command} 6291223918622`
...
case 'tiktokwm':
 if (!q) return m.reply('Linknya?')
            ...
            .then((data) => { sendFileFromUrl(m.chat, data.result.nowatermark,`By *Riyo Xdz*\nJgnLupa Subs *RIYO XDZ*\nYT : https://bit.ly/3GtHDNH`) })
...
break
case 'eroneko':
sendFileFromUrl(m.chat, `https://api.dhamzxploit.my.id/api/nsfw/neko`, `By *Riyo Xdz*\nJgnLupa Subs *RIYO XDZ*\nYT : https://bit.ly/3GtHDNH`)
break
case 'neko':
sendFileFromUrl(m.chat, `https://api.dhamzxploit.my.id/api/neko`, `By *Riyo Xdz*\nJgnLupa Subs *RIYO XDZ*\nYT : https://bit.ly/3GtHDNH`)
break
case 'futanari':
buffer = await getBuffer(`https://api.dapuhy.xyz/api/nsfw/nsfwfutanari?apikey=Riyo`)
hisoka.sendMessage(m.chat, {image : buffer, caption : `By *Riyo Xdz*\nJgnLupa Subs *RIYO XDZ*\nYT : https://bit.ly/3GtHDNH`}, {quoted : fgif})
break
case 'asupan':
m.reply(mess.wait)
sendFileFromUrl(m.chat, `https://api.zacros.my.id/asupan/random`, `By *Riyo Xdz*\nJgnLupa Subs *RIYO XDZ*\nYT : https://bit.ly/3GtHDNH`)
break
case 'bocil':
case 'santuy':
case 'rikagusriani':
...
sendFileFromUrl(m.chat, `${anu.result.url}`, `By *Riyo Xdz*\nJgnLupa Subs *RIYO XDZ*\nYT : https://bit.ly/3GtHDNH`)
break
...
case 'inori':
          ...
          sendFileFromUrl(m.chat,`${pii}`,`By *Riyo Xdz*\nJgnLupa Subs *RIYO XDZ*\nYT : https://bit.ly/3GtHDNH`)
break
case 'menu': case 'help':{
